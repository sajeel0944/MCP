...
async def main():
    ...
    #                                                                      cache_tools_list ko True kar dia hai ab Ye MCP server tool list ko cache karega
    async with MCPServerStreamableHttp(params=params_config, name="cache", cache_tools_list=True) as mcp_server:
